...
class BamlStreamClient:
    ...
    def AnalyzeIncident(
        ...
        query: str,similar_incidents_str: str,
        baml_options: _baml.BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[_baml.partial_types.RootCauseAnalysis, _baml.types.RootCauseAnalysis]:
      options: _baml.BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[_baml.partial_types.RootCauseAnalysis, _baml.types.RootCauseAnalysis](
        raw,
    ...
    def EvaluateResponse(
        ...
        prompt: str,response: str,
        baml_options: _baml.BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[_baml.partial_types.JudgeEvaluation, _baml.types.JudgeEvaluation]:
      options: _baml.BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[_baml.partial_types.JudgeEvaluation, _baml.types.JudgeEvaluation](
        raw,
