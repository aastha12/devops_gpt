...
class BamlAsyncClient:
    ...
    async def AnalyzeIncident(
        self,
        query: str,similar_incidents_str: str,
        baml_options: _baml.BamlCallOptions = {},
    ) -> _baml.types.RootCauseAnalysis:
      ...
      raw = await self.__runtime.call_function(
        "AnalyzeIncident",
        {
          "query": query,"similar_incidents_str": similar_incidents_str,
        },
      ...
      return cast(_baml.types.RootCauseAnalysis, raw.cast_to(_baml.types, _baml.types, _baml.partial_types, False))
    
    async def EvaluateResponse(
        self,
        prompt: str,response: str,
        baml_options: _baml.BamlCallOptions = {},
    ) -> _baml.types.JudgeEvaluation:
      options: _baml.BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      ...
      return cast(_baml.types.JudgeEvaluation, raw.cast_to(_baml.types, _baml.types, _baml.partial_types, False))
...
class BamlStreamClient:
    ...
    def AnalyzeIncident(
        ...
        query: str,similar_incidents_str: str,
        baml_options: _baml.BamlCallOptions = {},
    ) -> baml_py.BamlStream[_baml.partial_types.RootCauseAnalysis, _baml.types.RootCauseAnalysis]:
      options: _baml.BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[_baml.partial_types.RootCauseAnalysis, _baml.types.RootCauseAnalysis](
        raw,
        lambda x: cast(_baml.partial_types.RootCauseAnalysis, x.cast_to(_baml.types, _baml.types, _baml.partial_types, True)),
        lambda x: cast(_baml.types.RootCauseAnalysis, x.cast_to(_baml.types, _baml.types, _baml.partial_types, False)),
        self.__ctx_manager.get(),
      )
    ...
    def EvaluateResponse(
        ...
        prompt: str,response: str,
        baml_options: _baml.BamlCallOptions = {},
    ) -> baml_py.BamlStream[_baml.partial_types.JudgeEvaluation, _baml.types.JudgeEvaluation]:
      options: _baml.BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[_baml.partial_types.JudgeEvaluation, _baml.types.JudgeEvaluation](
        raw,
        lambda x: cast(_baml.partial_types.JudgeEvaluation, x.cast_to(_baml.types, _baml.types, _baml.partial_types, True)),
        lambda x: cast(_baml.types.JudgeEvaluation, x.cast_to(_baml.types, _baml.types, _baml.partial_types, False)),
        self.__ctx_manager.get(),
      )
